...
class TrainArgs(Tap):
    ...
    l_norm_coeff: float = None 
    entr_coeff: float = None 
    channel_weight_decay: float = 0.001 
    combinator_weight_decay: float = 0.0 
    end_temp: float = 0.3 
    combinator_temp: float = None 
...
class CommonArgs(Tap):
    ...
    task: Literal['plaus', 'train', 'test', 'plot_panel', 'eval_metric', 'test_motif', 'permute_attention', 'plot_sampling', 'stability_detector', 'plot_global', 'plot_explanations', 'print_faith'] = None  #: Running mode. Allowed: 'train' and 'test'.

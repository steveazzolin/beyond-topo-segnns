...
# # plt.colorbar()
# plt.savefig("GOOD/kernel/pipelines/plots/illustrations/manual/scatter_trio.png")
# plt.close()
...
# plt.colorbar()
plt.savefig("GOOD/kernel/pipelines/plots/illustrations/manual/hmean_faith_plaus.png")
plt.close()
...
# axs[2, -1].legend(handles=legend_elements, loc='upper left') #, loc='center'
# plt.colorbar()
plt.savefig("GOOD/kernel/pipelines/plots/illustrations/manual/low_discrepancy.png")
plt.close()
